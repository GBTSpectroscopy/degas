...
scriptDir = os.environ['SCRIPTDIR']
regridDir=os.path.join(os.environ['ANALYSISDIR'],release.replace('_spatialR21','')+'_regrid_33as')
outDir = os.path.join(os.environ['ANALYSISDIR'],'stack_'+release+"_33as")
#outDir = os.path.join(os.environ['ANALYSISDIR'],'stack_test')

myresults = makeSampleTable(regridDir, outDir, scriptDir, vtype='mom1',outname='stack_'+release+"_33as", release='DR1',R21='sigmaSFR')
