...
ratio_plots(degas, stack, ydata='ratio_HCN_CO',xdata='r25',pltname=os.path.join(plotdir,"fdense_vs_r25_IR6p1_mom1"))
ratio_plots(degas, stack, ydata='ratio_HCN_CO',xdata='mstar',pltname=os.path.join(plotdir,"fdense_vs_mstar_IR6p1_mom1"))
ratio_plots(degas, stack, ydata='ratio_HCN_CO',xdata='ICO',pltname=os.path.join(plotdir,"fdense_vs_ICO_IR6p1_mom1"))
