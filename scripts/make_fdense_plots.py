...
ratio_plots(degas, stack3, ydata='ratio_HCN_CO',xdata='r25',pltname=os.path.join(plotdir,"fdense_vs_r25_IR6p1_33as_mom1"),pltlabel=r'constant R$_{21}$')
ratio_plots(degas, stack3, ydata='ratio_HCN_CO',xdata='mstar',pltname=os.path.join(plotdir,"fdense_vs_mstar_IR6p1_33as_mom1"),pltlabel=r'constant R$_{21}$')
ratio_plots(degas, stack3, ydata='ratio_HCN_CO',xdata='ICO',pltname=os.path.join(plotdir,"fdense_vs_ICO_IR6p1_33as_mom1"),pltlabel=r'constant R$_{21}$')

ratio_plots(degas, stack3, ydata='ratio_ltir_mean_HCN',xdata='r25',pltname=os.path.join(plotdir,"sfe_dense_vs_r25_IR6p1_33as_mom1"))
ratio_plots(degas, stack3, ydata='ratio_ltir_mean_HCN',xdata='mstar',pltname=os.path.join(plotdir,"sfe_dense_vs_mstar_IR6p1_33as_mom1"))
ratio_plots(degas, stack3, ydata='ratio_ltir_mean_HCN',xdata='ICO',pltname=os.path.join(plotdir,"sfe_dense_vs_ICO_IR6p1_33as_mom1"))
