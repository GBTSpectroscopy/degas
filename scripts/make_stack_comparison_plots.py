...
# Do galaxy/line combos with DEGAS, EMPIRE
stack_list = [stack_33as, stack_empire]
stack_name_list = ['DEGAS (33 arcsec)',  'EMPIRE (DEGAS CODE)']

overlaplist = ['NGC5055','NGC6946']
linelist = ['HCN']
