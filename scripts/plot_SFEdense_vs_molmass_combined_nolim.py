...
for (galaxy,color,marker) in zip(degas[dr1],colorlist,markerlist):
    ...
    ax.errorbar(molmass[~lolims], sfe_dense[~lolims],
...
fig.savefig(os.path.join(plotDir,'sfe_dense_vs_molmass_combined_nolim.pdf'))    
fig.savefig(os.path.join(plotDir,'sfe_dense_vs_molmass_combined_nolim.png'))    
