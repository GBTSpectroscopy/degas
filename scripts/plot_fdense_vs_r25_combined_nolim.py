...
for (galaxy,color,marker) in zip(degas[dr1],colorlist,markerlist):
    ...
    ax.errorbar(r25[~lolims], fdense[~lolims],
...
fig.savefig(os.path.join(plotDir,'fdense_vs_r25_combined_nolim.pdf'))    
fig.savefig(os.path.join(plotDir,'fdense_vs_r25_combined_nolim.png'))    
